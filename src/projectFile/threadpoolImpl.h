...
namespace threads
{
	...
	public:
		...
		void waitForOne();
		void addJob(const compiler::ICompiler &a_compiler, const CParameters &a_parameters, const std::string a_sCompileFile, compileFile::INCLUDES_TO_IGNORE &a_includesToIgnore) override;
